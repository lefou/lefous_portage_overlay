...
############################
# ac32ogg/vob2ogg 
# Shell script to convert easyly to ogg vorbis
#
# Author: Tobias Roeser, 2003-2005
# Version: 0.2
# License: GPL-2
...
############################
# Which mode?
if [ "$(basename $0)" == "ac32ogg" ]; then
    mode="ac3"
elif [ "$(basename $0)" == "vob2ogg" ]; then
    mode="vob"
else  
...
then
    ...
    echo ""
    echo "(c) 2003-2005 written by Tobias Roeser"
    exit 0
fi
...
# Converting from vob
    ...
    echo ">>> Encoding VOBs from $vobDir..."
