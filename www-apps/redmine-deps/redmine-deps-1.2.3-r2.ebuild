...
LICENSE="GPL-2"
SLOT="0"
IUSE="cvs fastcgi git imagemagick mercurial mysql openid passenger postgres sqlite3 subversion"
...
ruby_add_rdepend "=dev-ruby/coderay-0.9*
...
ruby_add_rdepend subversion ">=dev-vcs/subversion-1.3"
ruby_add_rdepend git dev-vcs/git
ruby_add_rdepend cvs ">=dev-vcs/cvs-1.12"
ruby_add_rdepend mercurial dev-vcs/mercurial
