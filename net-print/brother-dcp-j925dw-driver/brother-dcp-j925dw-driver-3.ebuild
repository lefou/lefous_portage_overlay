...
DESCRIPTION="The LPR and cupswrapper driver for the Brother DCP-J925DW"
HOMEPAGE="http://welcome.solutions.brother.com/BSC/public/eu/de/de/model_top/colormfc/dcpj925dw_eu_as.html?reg=eu&c=de&lang=de&prod=dcpj925dw_eu_as"
SRC_URI="http://www.brother.com/pub/bsc/linux/dlf/dcpj925dwlpr-3.0.1-1.i386.deb http://www.brother.com/pub/bsc/linux/dlf/dcpj925dwcupswrapper-3.0.0-1.i386.deb"
LICENSE=""
SLOT="0"
KEYWORDS="~x86 ~amd64"
IUSE=""
...
src_unpack() {
        mkdir lpr
        mkdir cupswrapper
        (cd lpr && unpack dcpj925dwlpr-3.0.1-1.i386.deb)
        (cd cupswrapper && unpack dcpj925dwcupswrapper-3.0.0-1.i386.deb)
